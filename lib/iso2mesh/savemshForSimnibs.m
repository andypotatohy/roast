function savemshForSimnibs(node,elem,fname,rname)
%
% savemshForSimnibs(node,elem,fname,rname)
%
% save a tetrahedral mesh to GMSH mesh format, specifically for SimNIBS
%
% author: Riccardo Scorretti (riccardo.scorretti<at> univ-lyon1.fr)
% date: 2013/07/22
%
% Yu Andy Huang modified on 2017/07/31
%
% input:
